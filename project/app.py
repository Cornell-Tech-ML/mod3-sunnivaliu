...
from interface.streamlit_utils import get_img_tag # type: ignore
from interface.train import render_train_interface # type: ignore # type: ignore
from math_interface import render_math_sandbox # type: ignore # type: ignore
from run_torch import TorchTrain # type: ignore
...
if module_selection == "Module 0":
    from module_interface import render_module_sandbox # type: ignore # type: ignore
    from run_manual import ManualTrain # type: ignore # type: ignore
...
if module_selection == "Module 1":
    from run_scalar import ScalarTrain # type: ignore # type: ignore
    from show_expression_interface import render_show_expression # type: ignore
...
if module_selection == "Module 2":
    from run_tensor import TensorTrain # type: ignore
    from show_expression_interface import render_show_expression # type: ignore
    from tensor_interface import render_tensor_sandbox # type: ignore
...
if module_selection == "Module 3":
    from run_fast_tensor import FastTrain # type: ignore # type: ignore
...
if module_selection == "Module 4":
    from run_mnist_interface import render_run_image_interface # type: ignore
    from sentiment_interface import render_run_sentiment_interface # type: ignore
